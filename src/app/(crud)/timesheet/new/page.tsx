...
export default function Page(): React.ReactElement {
	...
	const [ORDERED_DATA, swapKey] = useOrderedData<Timesheet, typeof KEYS>('time_begin', timesheetValuators, KEYS);
	return <>
		<TimesheetForm
			id='new-timesheet-form'
			// WARN: passing function (i.e. not using closure) changes 'this' context
			onSubmit={t => ORDERED_DATA.append(t)}
		/>
