...
const NewForm: IdEventsHandlerNewForm<Job> = props => <JobForm {...props} id={`${props.id}--job--new`} />;
const SearchForm: IdEventsHandlerSearchForm<Job> = props => <MatchJobForm {...props} id={`${props.id}--job--search`} />;
