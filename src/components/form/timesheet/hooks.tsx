...
const NewForm: IdEventsHandlerNewForm<Timesheet> = props => <TimesheetForm {...props} id={`${props.id}--timesheet--new`} />;
const SearchForm: IdEventsHandlerSearchForm<Timesheet> = props => <MatchTimesheetForm {...props} id={`${props.id}--timesheet--search`} />;
