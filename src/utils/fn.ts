...
export type AsyncFn<Params extends any[], Return> = Fn<Params, Promise<Return>>;
 ...
 * ```
 */
export type Fn<Params extends any[], Return> = Params extends [...infer Param] ? (...param: Param) => Return : never;
